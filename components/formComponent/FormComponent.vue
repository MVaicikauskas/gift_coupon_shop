        ...
        <template v-if="step === 1">
            ...
            <div class="mt-20 grid grid-cols-1">
                <div class="grid md:grid-cols-2 sm:grid-cols-1 gap-4 my-3.5">
                    ...
                    <div>
                        <label for="value" class="mb-1 text-sm block font-semibold">
                            {{ 'Kupono vertė' }}
                            <span class="font-normal text-black ps-1">{{ '(minimali vertė 20 Eur)' }}</span>
                        </label>
                        <select id="value" class="bg-white border h-[53px] border-gray-200 text-base rounded-md focus:border-[#6269ed] focus:border-2 block w-full p-[16px] placeholder:text-sm">
                            <option value="20" selected class="text-black text-sm">{{ '20 €' }}</option>
                            <option value="30" class="text-black text-sm">{{ '30 €' }}</option>
                ...
                <div class="flex items-center justify-between flex-wrap sm:flex-nowrap mb-[14px] mt-[3px]">
                    ...
                    <div class="flex flex-wrap">
                        <div class="flex md:justify-end sm:justify-start mt-4 pr-5">
                            <button class="py-3 px-4 bg-[#e5e7ea] text-[#6269ed] text-[15px] font-medium rounded-lg flex">
                        ...
                        <div class="flex md:justify-end sm:justify-start mt-4">
                            <button class="py-3 pl-8 pr-6 bg-[#6269ed] text-[#e5e7ea] text-center text-[15px] font-medium rounded-lg flex">
                                <span class="my-auto">
                                    {{ 'Toliau' }}
                                </span>
