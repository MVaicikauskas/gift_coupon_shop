            ...
            <ol class="mx-auto mt-8 flex lg:w-6/12 md:w-11/12 sm:w-full lg:px-4 md:px-2 sm:px-1 max-w-lg items-center justify-between">
                <li class="flex w-full items-center">
                    <div class="relative flex flex-col items-center">
                        ...
                        <div class="absolute top-0 mt-8 w-32 text-center font-semibold text-sm"
            ...
            <div class="mt-20 grid grid-cols-1">
                <div class="grid md:grid-cols-2 sm:grid-cols-1 gap-4 my-3.5">
                    <div>
                        ...
                        <input id="name" type='text' placeholder='Įveskite gavėjo vardą'
                               class="px-4 py-2.5 text-base rounded-md bg-white border border-gray-200 w-full outline-[#6269ed] placeholder:text-base" />
                    </div>
                    <div>
                        ...
                        <select id="value" class="bg-white border border-gray-200 text-base rounded-md focus:border-[#6269ed] focus:border-2 block w-full px-4 py-2.5 placeholder:text-base">
                ...
                <div class="my-3.5">
                    ...
                    <input type='text' placeholder='Įveskite savo el.paštą' id="email"
                           class="py-2.5 px-4 h-12 text-base rounded-md bg-white border border-gray-200 w-full outline-[#6269ed] placeholder:text-base" />
                </div>
                ...
                <div class="my-3.5">
                    ...
                    <textarea type='text' placeholder='Palinkėjimo tekstas' id="textarea"
                           class="px-4 py-2.5 h-28 text-base rounded-md bg-white border border-gray-200 w-full outline-[#6269ed] placeholder:text-base" />
                </div>
                ...
                <div class="flex items-center justify-between flex-wrap sm:flex-nowrap mb-3">
                    <div class="text-base md:w-1/3 sm:w-full mt-4">
                        <a href="#" class="text-[#acaeb0] group flex">
                            ...
                            <span class="font-medium text-base group-hover:font-semibold">{{ ' Atgal' }}</span>
                        </a>
                    </div>
                    <div class="flex flex-wrap">
                        <div class="flex md:justify-end sm:justify-start mt-4 pr-5">
                            <button class="py-3 px-4 bg-[#e5e7ea] text-[#6269ed] text-base font-medium rounded-lg flex">
                        ...
                        <div class="flex md:justify-end sm:justify-start mt-4">
                            <button class="py-3 pl-8 pr-6 bg-[#6269ed] text-[#e5e7ea] text-center text-base font-medium rounded-lg flex">
                                <span class="my-auto">
                                    {{ 'Toliau' }}
                                </span>
