            ...
            <div class="">
                <details class="group bg-[#f3f4f8] rounded-xl px-5 py-1 my-2">
                    <summary class="flex gap-4 cursor-pointer list-none items-center justify-between py-4 text-lg font-medium text-secondary-900 group-open:text-primary-500">
                        <span class="font-semibold text-xl">{{ 'Svarbu žinoti!' }}</span>
                        <div>
                ...
                <details class="group bg-[#f3f4f8] rounded-xl px-5 py-1 my-2">
                    <summary class="flex gap-4 cursor-pointer list-none items-center justify-between py-4 text-lg font-medium text-secondary-900 group-open:text-primary-500">
                        <span class="font-semibold text-xl">{{ 'Kur galima išleisti dovanų kuponą?' }}</span>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 -0.5 21 21" version="1.1"
                                 class="block h-5 w-5 group-open:hidden">
                                <g id="Page-1" stroke="none" stroke-width="2" fill="none" fill-rule="evenodd">
                ...
                <details class="group bg-[#f3f4f8] rounded-xl px-5 py-1 my-2">
                    <summary class="flex gap-4 cursor-pointer list-none items-center justify-between py-4 text-lg font-medium text-secondary-900 group-open:text-primary-500">
                        <span class="font-semibold text-xl">{{ 'Noriu atšaukti docanų kuponą - ką turėčiau daryti?' }}</span>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 -0.5 21 21" version="1.1"
                                 class="block h-5 w-5 group-open:hidden">
                                <g id="Page-1" stroke="none" stroke-width="2" fill="none" fill-rule="evenodd">
                ...
                <details class="group bg-[#f3f4f8] rounded-xl px-5 py-1 my-2">
                    <summary class="flex gap-4 cursor-pointer list-none items-center justify-between py-4 text-lg font-medium text-secondary-900 group-open:text-primary-500">
                        <span class="font-semibold text-xl">{{ 'Kaip pritaikyti dovanų kupono kodą?' }}</span>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 -0.5 21 21" version="1.1"
                                 class="block h-5 w-5 group-open:hidden">
                                <g id="Page-1" stroke="none" stroke-width="2" fill="none" fill-rule="evenodd">
                ...
                <details class="group bg-[#f3f4f8] rounded-xl px-5 py-1 my-2">
                    <summary class="flex gap-4 cursor-pointer list-none items-center justify-between py-4 text-lg font-medium text-secondary-900 group-open:text-primary-500">
                        <span class="font-semibold text-xl">{{ 'Kiek galioja "Įmonė" dovanų kuponas?' }}</span>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 -0.5 21 21" version="1.1"
                                 class="block h-5 w-5 group-open:hidden">
                                <g id="Page-1" stroke="none" stroke-width="2" fill="none" fill-rule="evenodd">
